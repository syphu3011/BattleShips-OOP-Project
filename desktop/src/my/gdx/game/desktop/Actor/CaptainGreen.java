...
public class CaptainGreen extends Captain {
    public static String id = "001-";
    public CaptainGreen(String textureName,Point Position, Size size,String id,int price,String attribute,double bonus) {
        super(textureName, Position,size,id,price,attribute,bonus);
    }
    public CaptainGreen(String textureName,String id,int price,String attribute,double bonus) {
        super(textureName,id,price,attribute,bonus);
    }
    @Override
    public Animation<AtlasRegion> getAnimate() {
        // TODO Auto-generated method stub
        return Asset.captainGreenAnim;
    }
}
